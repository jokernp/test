...
<table width="150" valign="center" align="center"><strong><font size="4" color="blue"><br>修改图书信息</font></strong></table><br>
...
<table width="1024" height="48" border="1" cellpadding="0" cellspacing="0" align="center">
 <tr>
	...
	<tr>
		...
		<td width="400" align="center"><input type="text" name="state" class="input" value=<%=book.getState()==0?"全借出" : "有在馆"%>>
		<br/>全借出：0 有在馆：1</td>
	</tr>
	</table>
	<p></p>
